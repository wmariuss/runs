...
urls_list = {
        'Development': 'https://ifconfig.co',
        'Staging': 'https://ifconfig.co'
    }

client = Client(endpoint=os.environ['ALERTA_ENDPOINT'],
                key=os.environ['ALERTA_KEY'],
                ssl_verify=False)
...
for stage in urls_list:
    ...
    send = client.send_alert(resource='Ping',
                             event='StatusCode',
